...
public class SuggestDownloadScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.drawCenteredString(matrices, this.textRenderer, "Do you want to download seedbank?", width / 2, height / 3, 0xFFFFFF);
    ...
    protected void init() {
        this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 96, 150, 20, ScreenTexts.YES, buttonWidget -> {
            client.openScreen(new DownloadingSeedbankScreen());
        }));
